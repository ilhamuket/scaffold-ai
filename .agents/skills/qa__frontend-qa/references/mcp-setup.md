...
MCP (Model Context Protocol) Playwright memungkinkan assistant runtime mengontrol browser
...
— cukup konfigurasi agar runtime yang kompatibel bisa memanggilnya via `npx`.
...
Setelah konfigurasi, verifikasi dengan cara meminta assistant runtime melakukan:

1. Buka halaman utama aplikasi
2. Ambil screenshot
3. Deskripsikan apa yang terlihat

Jika assistant runtime bisa mendeskripsikan isi halaman dari screenshot → MCP berjalan dengan benar.
