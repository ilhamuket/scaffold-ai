...
3. Check adherence to project best practices and coding standards from `AGENTS.md` or `CLAUDE.md`
...
5. **Best Practices**:
   - Follow project-specific standards from `AGENTS.md` or `CLAUDE.md`
...
- Missing context (no `AGENTS.md` or `CLAUDE.md`): Apply general best practices
