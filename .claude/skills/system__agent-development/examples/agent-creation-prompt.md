...
Use this template to generate agents using the active assistant with the agent creation system prompt.
...
Send this to the active assistant (with the agent-creation-system-prompt loaded):
...
Tell the assistant when the agent should activate:
...
- **Comprehensive**: The assistant includes edge cases and quality checks
