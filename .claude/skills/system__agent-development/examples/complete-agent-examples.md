...
3. Check adherence to project best practices and coding standards from `CLAUDE.md` or `AGENTS.md`
...
5. **Best Practices**:
   - Follow project-specific standards from `CLAUDE.md` or `AGENTS.md`
...
- Missing context (no `CLAUDE.md` or `AGENTS.md`): Apply general best practices
