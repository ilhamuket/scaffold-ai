...
assistant: "[How the active assistant should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How the active assistant triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what the active assistant says before launching the agent
...
**Purpose:** Show how the active assistant invokes the agent
...
- Show the active assistant using the Agent tool
